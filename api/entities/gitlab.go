...
const (
	...
	// GitlabRequestObjectNamePush represents a push request object name
	GitlabRequestObjectNamePush GitlabRequestObjectName = "push"
)
...
const (
	...
	UnapproveAction         = "unapproved"
	ApprovalAction          = "approval"
	UnapprovalAction        = "unapproval"
	MergeAction             = "merge"
)
